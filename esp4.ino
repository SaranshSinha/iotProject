...
int getFingerprintIDez() {
  Serial.println("Waiting for a voter...");
  uint8_t p = finger.getImage();
...
gsm.begin(9600);
  ...
  gsm.println("AT+CMGS=\"+917892221826\"\r"); // Replace x with mobile number
  delay(1000);
  gsm.println("Thanks for voting.");// The SMS text you want to send
  delay(100);
