...
def populateTagSummary(frame):
    ...
    Label(expenseFrame, text = 'Expense', pady = 5,width=50,height = 3,borderwidth='1',relief = 'solid', bg='red3',pady=3,fg='white',font=('Copperplate Gothic Bold','13')).grid(row=0, column = 0)
    Label(expenseFrame, text = 'Rs 4000', pady = 5,width=50,height = 3,borderwidth='1',relief = 'solid',bg='red3',pady=3,fg='white',font=('Copperplate Gothic Bold','13')).grid(row=0, column = 1)

    #database
    i=1
    cursor = conn.execute("SELECT * FROM Expense WHERE type='expense'")
    for r in cursor:
        Label(expenseFrame, text = "%s"%r[2],pady = 5,width=50,height = 3,borderwidth='1',relief = 'solid', bg='red4',pady=3,fg='white',font=('Copperplate Gothic Bold','13')).grid(row=i,column=0)
        Label(expenseFrame, text = "%s"%r[4],pady = 5,width=50,height = 3,borderwidth='1',relief = 'solid', bg='red4',pady=3,fg='white',font=('Copperplate Gothic Bold','13')).grid(row=i,column=1)
        i+=1
    
    
    Label(expenseFrame, text = 'Income', pady = 5,width=50,height = 3,borderwidth='1',relief = 'solid', bg='SpringGreen4',pady=3,fg='white',font=('Copperplate Gothic Bold','13')).grid(row=i, column = 0)
    Label(expenseFrame, text = 'Rs 14000', pady = 5,width=50,height = 3,borderwidth='1',relief = 'solid', bg='SpringGreen4',pady=3,fg='white',font=('Copperplate Gothic Bold','13')).grid(row=i, column = 1)
    i+=1

    cursor = conn.execute("SELECT * FROM Expense WHERE type='income'")

    for r in cursor:
        Label(expenseFrame, text = "%s"%r[2],pady = 5,width=50,height = 3,borderwidth='1',relief = 'solid', bg='green',pady=3,fg='white',font=('Copperplate Gothic Bold','13')).grid(row=i,column=0)
        Label(expenseFrame, text = "%s"%r[4],pady = 5,width=50,height = 3,borderwidth='1',relief = 'solid', bg='green',pady=3,fg='white',font=('Copperplate Gothic Bold','13')).grid(row=i,column=1)
        i+=1
